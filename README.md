...
- **BRAZILIAN CAR DEALERSHIP [(In progress)](https://github.com/Marckelson/Vehicle-dealership):** The project aims to implement a real-world project using common tools like AWS ECS, Airflow, DBT, Snowflake, and Postgres. The main task of this job was to provide reliable and consistent sales data to the sales manager in Brazil. 
- **Project Name 2:** 
- **Project Name 3:** 
